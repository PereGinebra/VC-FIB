...
boxImportance = 1; %importancia de la distancia del rectangle, de 0-5 mes o menys (on 0 no importa i 5 vastant)
O(:,5) = distToCenter(:)/(norm([0,0]-[n,m])/boxImportance); %per rectangles 'petits' en relació a l'objecte, considera els punts mes llunyans al rectangle com mes diferents
...
H = [C, distToCenter(:)];
distanceToFocus = 0.40; %how many half diagonals do you want the window's diagonal to be
